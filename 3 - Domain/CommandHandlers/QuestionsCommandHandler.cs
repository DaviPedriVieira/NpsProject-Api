...
namespace NpsApi._3___Domain.CommandHandlers
{
    public class QuestionsCommandHandler
    {
        ...
        public async Task<List<Question>> CreateQuestion(List<Question> questions)
        {
            ...
            return await _questionsRepository.CreateQuestion(questions);
        }
        ...
        public async Task<List<int>> GetQuestionIdByFormId(int formId)
        {
            return await _questionsRepository.GetQuestionsIdByFormIds(formId);
        }
    }
}
